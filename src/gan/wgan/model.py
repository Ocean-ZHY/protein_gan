...
from src.gan.wgan.discriminator import discriminator_fully_connected, original_discriminator, discriminator_resnet
from src.gan.wgan.generator import generator_fully_connected, original_generator, generator_resnet
