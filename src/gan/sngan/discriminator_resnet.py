...
from src.common.model.generator_ops import get_kernel
from src.common.model.ops import sn_block, attention
from src.gan.sngan.discriminator import Discriminator
