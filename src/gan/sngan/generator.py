...
from src.gan.sngan.base_model import Model
from src.common.model.generator_ops import get_dimentions_factors, get_kernel, sn_block
from src.common.model.ops import leaky_relu, log, attention
